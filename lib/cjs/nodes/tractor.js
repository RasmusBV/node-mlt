...
(function (Tractor) {
    class Builder {
        ...
        addFilter(filter, track, timestamp = {}) {
            ...
            this.builder.addChild({ node: filter, context: Object.assign({ track: index }, timestamp) });
            return this;
        }
        addTransition(transition, a_track, b_track, timestamp = {}) {
            ...
            this.builder.addChild({ node: transition, context: Object.assign({ a_track: a_index, b_track: b_index }, timestamp) });
            return this;
        }
        build() {
